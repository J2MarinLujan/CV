  ...
  <footer class="center-center cursor-default">
    <div class="pt-8 px-0 pb-44 sm:pb-10">
      ...
      <ul class="center-center gap-3 mb-8">
        ...
        <li>
          <a href="#portafolio" class="footer__link text-primary hover:text-secondary">
            Portafolio
          </a>
        </li>
        <li>
          <a href="#skills" class="footer__link text-primary hover:text-secondary"> Habilidades </a>
        </li>
      </ul>
